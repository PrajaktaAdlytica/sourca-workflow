const logos = ["LPP", "Żabka", "Amica", "CCC", "ORLEN", "Synthos", "Valeo", "PZU", "KGHM", "Allegro", "ING", "Play"];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-8 relative overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
          <div className="flex gap-16 animate-marquee w-max">
            {[...logos, ...logos].map((l, i) => (
              <div key={i} className="text-2xl font-semibold text-primary/40 hover:text-primary/70 transition-colors tracking-tight shrink-0">
                {l}
              </div>
            ))}
          </div>
