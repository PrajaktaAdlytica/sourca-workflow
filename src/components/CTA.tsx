  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="surface-card relative overflow-hidden p-10 md:p-14">
        ...
        <div className="absolute -left-24 -bottom-24 h-72 w-72 rounded-full bg-teal/15 blur-3xl" />
        <div className="relative grid gap-8 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-4 text-[15px] text-muted-foreground max-w-md">
              See how Sourcixa helps procurement teams discover, evaluate and manage suppliers
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <ButtonLink to="/request-demo" variant="outline" size="lg">
                Contact Sales
              </ButtonLink>
            </div>
          </div>
...
function MiniPreview() {
  return (
    <div className="surface-card p-4 space-y-2">
      {[
        { n: "ElectroCo", c: "Poland", s: "Best Match" },
