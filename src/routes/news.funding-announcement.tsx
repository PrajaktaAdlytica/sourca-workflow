...
const TITLE = "OriginCue secures $590K in funding from Gama VC";
const DESCRIPTION =
  "OriginCue has secured $590K in funding from Gama VC to build supply-chain intelligence for complex operating environments.";
      ...
      <article className="mx-auto max-w-4xl px-6 pb-24 pt-16 sm:pt-20">
        ...
        <header className="mt-12 border-b border-border pb-10">
          ...
          <p className="mt-6 max-w-2xl text-[17px] leading-relaxed text-muted-foreground">
            OriginCue is funded by {INVESTOR_NAME} to build supply-chain intelligence for complex
        ...
        <div className="grid gap-10 py-12 md:grid-cols-[minmax(0,1fr)_240px]">
          <div className="space-y-6 text-[16px] leading-8 text-primary/80">
            <p>OriginCue has secured $590K in funding from {INVESTOR_NAME}.</p>
            <p>
              OriginCue operates in supply-chain intelligence, supporting teams working across
              supplier discovery, RFQs and supplier risk.
            </p>
            <p>
              With funding from {INVESTOR_NAME}, OriginCue continues building for complex operating
              environments.
            </p>
          </div>
          <aside
          ...
          >
            ...
            <dl className="mt-5 space-y-4 text-sm">
              ...
              <div>
                ...
                <dd className="mt-1 font-semibold text-primary">{INVESTOR_NAME}</dd>
              </div>
              <div>
        ...
        <div className="rounded-xl border border-accent/20 bg-accent-soft/45 p-6 sm:flex sm:items-center sm:justify-between sm:gap-6">
          <div>
            <div className="text-sm font-semibold text-primary">Visit Gama VC</div>
            <p className="mt-1 text-sm text-muted-foreground">
              Learn more about the investor backing OriginCue.
            </p>
          </div>
          <a
            href={INVESTOR_URL}
