      ...
      <div className="flex items-center justify-center px-6 py-14 bg-network">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-sm">
          ...
          <form className="mt-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
            <Field label="Email"><input type="email" placeholder="you@company.com" className="input" /></Field>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button type="button" className="h-10 rounded-lg border border-border bg-surface text-primary text-xs font-medium hover:bg-secondary transition-colors">Google</button>
              <button type="button" className="h-10 rounded-lg border border-border bg-surface text-primary text-xs font-medium hover:bg-secondary transition-colors">Microsoft</button>
            </div>
          </form>
